    ...
    return (
        <div className="specialized-page">
                ...
                <div className="specialized-container">
                    <div className="specialized-hero-grid">
                        ...
                        <div style={{ background: `linear-gradient(135deg, ${color1}, ${color2})`, borderRadius: '24px', height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white' }}>
                            <div style={{ textAlign: 'center' }}><div style={{ fontSize: '80px', fontWeight: 900 }}>+47%</div><div style={{ fontSize: '18px', opacity: 0.9 }}>Avg. Conversion Lift</div></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="specialized-cta"><div className="specialized-container"><div className="cta-grid">
                <div><h2 style={{ fontSize: '56px', fontWeight: 900, marginBottom: '30px', lineHeight: 1.1 }}>Ready to convert <span style={{ color: 'var(--accent-yellow)' }}>more visitors?</span></h2><p style={{ fontSize: '20px', opacity: 0.8, marginBottom: '50px', lineHeight: 1.6 }}>Get a free conversion audit.</p></div>
