                ...
                <div className="attr-container">
                    ...
                    <div className="pricing-grid">
                        <div className="price-card">
                            <h4 style={{ fontSize: '24px', fontWeight: 600, marginBottom: '20px' }}>Assessment</h4>
            ...
            <section className="attr-cta">
                <div className="attr-container">
                    <div className="cta-grid">
                        <div>
                            <h2 style={{ fontSize: '56px', fontWeight: 600, marginBottom: '30px', lineHeight: 1.1 }}>Ready to see <span style={{ color: 'var(--accent-yellow)' }}>the truth?</span></h2>
