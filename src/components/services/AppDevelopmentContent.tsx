                        ...
                        <div className="appdev-hero-visual">
                            <div className="phone-mockup">
                                ...
                                <div className="phone-screen">
                                    ...
                                    <div style={{ fontSize: '18px', fontWeight: 800 }}>Your App Here</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', gap: '80px', flexWrap: 'wrap' }}>
                        {[
                            ...
                            <div key={i} style={{ textAlign: 'center' }}>
                                <div style={{ fontSize: '36px', fontWeight: 900, background: 'linear-gradient(135deg, #3b82f6, #a855f7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{stat.value}</div>
                    ...
                    <div className="platforms-grid">
                        {[
                            ...
                            <div key={i} className="platform-card">
                                ...
                                <h3 style={{ fontSize: '24px', fontWeight: 800, marginBottom: '15px' }}>{platform.title}</h3>
                    ...
                    <div className="process-steps">
                        {[
                            ...
                            <div key={i} className="process-step">
                                <div style={{ fontSize: '32px', fontWeight: 900, color: '#c4b5fd', marginBottom: '10px' }}>{step.num}</div>
                ...
                <div className="appdev-container">
                    ...
                    <div className="pricing-grid">
                        <div className="price-card">
                            ...
                            <div style={{ fontSize: '42px', fontWeight: 900, marginBottom: '10px' }}>$25,000<span style={{ fontSize: '16px', color: '#999' }}>+</span></div>
                        ...
                        <div className="price-card featured">
                            ...
                            <h4 style={{ fontSize: '24px', fontWeight: 800, marginBottom: '20px' }}>Full App</h4>
                            <div style={{ fontSize: '42px', fontWeight: 900, marginBottom: '10px' }}>$75,000<span style={{ fontSize: '16px', color: '#999' }}>+</span></div>
            ...
            <section className="appdev-cta">
                <div className="appdev-container">
                    <div className="cta-grid">
                        <div>
                            <h2 style={{ fontSize: '56px', fontWeight: 900, marginBottom: '30px', lineHeight: 1.1 }}>Ready to launch <span style={{ color: 'var(--accent-yellow)' }}>your app?</span></h2>
                        ...
                        <div className="cta-form">
                            <form style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                ...
                                <button type="submit" className="btn-primary" style={{ border: 'none', background: 'linear-gradient(135deg, #3b82f6, #a855f7)', color: 'white', fontSize: '18px', fontWeight: 800, cursor: 'pointer', padding: '20px' }}>
