    ...
    return (
        <div className="specialized-page">
                    ...
                    <div className="specialized-hero-grid">
                        <div>
                            ...
                            <div className="content-hero-actions">
                                <Link href="/contact" className="btn-primary large" style={{ background: `linear-gradient(135deg, ${color1}, ${color2})`, border: 'none', color: 'white' }}>Launch Program<Icon type="arrowRight" /></Link>
                        ...
                        <div style={{ background: `linear-gradient(135deg, ${color1}, ${color2})`, borderRadius: '24px', height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white' }}>
                            <div style={{ textAlign: 'center' }}><div style={{ fontSize: '80px', fontWeight: 900 }}>$5M+</div><div style={{ fontSize: '18px', opacity: 0.9 }}>Revenue Generated</div></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="specialized-services"><div className="specialized-container">
                ...
                <div className="services-grid">
                    {[{ title: 'Program Setup', desc: 'Complete affiliate program launch including platform setup, commission structure, and tracking.' }, { title: 'Partner Recruitment', desc: 'Find and onboard high-quality affiliates who align with your brand and audience.' }, { title: 'Performance Management', desc: 'Ongoing optimization, fraud prevention, and partner relationship management.' }].map((s, i) => (
                        <div key={i} className="service-card" style={{ '--hover-color': color1 } as React.CSSProperties}><h3 style={{ fontSize: '24px', fontWeight: 800, marginBottom: '15px' }}>{s.title}</h3><p style={{ fontSize: '16px', color: '#64748b', lineHeight: 1.7 }}>{s.desc}</p></div>
                    ))}
                </div>
            </div></section>
            ...
            <section className="specialized-cta"><div className="specialized-container"><div className="cta-grid">
                <div><h2 style={{ fontSize: '56px', fontWeight: 900, marginBottom: '30px', lineHeight: 1.1 }}>Ready to build <span style={{ color: 'var(--accent-yellow)' }}>revenue partnerships?</span></h2><p style={{ fontSize: '20px', opacity: 0.8, marginBottom: '50px', lineHeight: 1.6 }}>Get a free affiliate program strategy consultation.</p></div>
                <div className="cta-form"><form style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}><input type="text" placeholder="Name" /><input type="email" placeholder="Email" /><input type="text" placeholder="Monthly Revenue" /><button type="submit" className="btn-primary" style={{ border: 'none', background: `linear-gradient(135deg, ${color1}, ${color2})`, color: 'white', fontSize: '18px', fontWeight: 800, cursor: 'pointer', padding: '20px' }}>Get Free Strategy</button></form></div>
            </div></div></section>
        </div>
    );
}
