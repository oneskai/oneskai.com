                    ...
                    <div className="trust-metrics">
                        {[
                            ...
                            <div key={i} className="trust-metric">
                                <div style={{ fontSize: '36px', fontWeight: 900, background: 'linear-gradient(135deg, #7c3aed, #ec4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{stat.value}</div>
                    ...
                    <div className="tech-grid">
                        {[
                            ...
                            <div key={i} className="tech-card">
                                ...
                                <h4 style={{ fontWeight: 800, marginBottom: '10px' }}>{tech.title}</h4>
                    ...
                    <div className="types-grid">
                        {[
                            ...
                            <div key={i} className="type-card">
                                ...
                                <h3 style={{ fontSize: '24px', fontWeight: 800, marginBottom: '15px' }}>{type.title}</h3>
                ...
                <div className="web-design-container">
                    ...
                    <div className="pricing-grid">
                        <div className="price-card">
                            ...
                            <div style={{ fontSize: '42px', fontWeight: 900, marginBottom: '10px' }}>$8K<span style={{ fontSize: '16px', color: '#999' }}>+</span></div>
                        ...
                        <div className="price-card featured">
                            ...
                            <div style={{ fontSize: '42px', fontWeight: 900, marginBottom: '10px' }}>$20K<span style={{ fontSize: '16px', color: '#999' }}>+</span></div>
                        ...
                        {[
                            ...
                            <div key={i} className="portfolio-item" style={{ background: `linear-gradient(135deg, ${project.color}40, ${project.color}80)` }}>
                                <div className="portfolio-overlay">
                                    ...
                                    <h4 style={{ fontSize: '24px', fontWeight: 800, marginTop: '8px' }}>{project.title}</h4>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="web-design-cta">
                <div className="web-design-container">
                    <div className="cta-grid">
                        <div>
                            <h2 style={{ fontSize: '56px', fontWeight: 900, marginBottom: '30px', lineHeight: 1.1 }}>Let&apos;s build your <span style={{ color: 'var(--accent-yellow)' }}>digital presence.</span></h2>
                        ...
                        <div className="cta-form">
                            <form style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                ...
                                <button type="submit" className="btn-primary" style={{ border: 'none', background: 'linear-gradient(135deg, #7c3aed, #ec4899)', color: 'white', fontSize: '18px', fontWeight: 800, cursor: 'pointer', padding: '20px' }}>
