    ...
    return (
        <div className="content-marketing-page">
                ...
                <div className="content-container">
                    <div className="content-hero-grid">
                        <div className="content-hero-content">
                            <span className="content-badge" style={{ background: 'rgba(255, 45, 117, 0.08)', color: 'var(--accent-pink)', border: '1px solid rgba(255, 45, 117, 0.1)' }}><Icon type="shoppingCart" />Ecommerce Growth</span>
                            <h1 className="content-hero-title">Scale Your <span className="title-accent">Online Revenue.</span></h1>
                            ...
                            <div className="content-hero-actions">
                                <Link href="/contact" className="btn-primary large" style={{ background: 'var(--primary-green)', border: 'none' }}>Get Ecom Audit<Icon type="arrowRight" /></Link>
            ...
            <section className="content-challenges">
                <div className="content-container">
                    <div className="section-header text-center">
                        ...
                        <h2 className="section-title">Ecommerce Is <span className="title-accent">Brutally Competitive</span></h2>
                    </div>
            ...
            <section className="content-services">
                <div className="content-container">
                    <div className="section-header"><span className="section-label">FULL-FUNNEL APPROACH</span><h2 className="section-title">Ecommerce <span className="title-accent">Solutions</span></h2></div>
            ...
            <section className="content-cta" style={{ background: 'var(--primary-green)' }}>
                <div className="content-container">
                    <div className="cta-box" style={{ background: 'transparent', boxShadow: 'none' }}>
                        <h2 style={{ color: 'var(--accent-yellow)' }}>Ready to <span style={{ color: '#dcfce7' }}>Scale Revenue?</span></h2>
                        <p style={{ fontSize: '20px', marginBottom: '40px', opacity: 0.9, color: 'var(--accent-yellow)' }}>Get a free ecommerce audit and see where you&apos;re leaving money on the table.</p>
